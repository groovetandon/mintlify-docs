...
<AccordionGroup>
  <Accordion title="Dex" icon="message">
    The conversational operator for Decisional. Dex helps you build agents, ask questions, change workflows, run one-off work, and monitor what happened.

    **Example:** Ask Dex to create an agent for quote review, then later ask it to explain a failed run or adjust the approval policy.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Public Mode" icon="share-nodes">
    The focused public run surface for an agent. Use it when someone should run or review an agent without accessing the full builder interface.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Output Data" icon="right-from-bracket">
    The results your agent produces. This can be written to worksheets, sent via integrations, or returned to another system.
...
| **Public Mode** | Agent Mode | Focused public run surface |
