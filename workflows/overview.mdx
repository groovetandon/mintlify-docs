...
If you need to make changes after building, just tell your agent — for example, "add a step to send a team-chat notification after the email is sent" — and it will update the workflow.
