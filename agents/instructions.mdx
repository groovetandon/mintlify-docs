...
Click an integration chip to open its connection panel. The panel lists the credentials, tools, and triggers attached to that integration.
...
Dex declares the exact tool where it is needed in the instructions. The editor displays that declaration as an inline tool chip. Clicking the chip opens the matching integration, tool, and credential in the connection panel. Clicking a tool in the connection panel highlights its declaration in the instructions.
