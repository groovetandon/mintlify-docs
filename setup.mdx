...
The Settings page is where admins define the default approval mode that agents inherit when they do not have an override.
...
<Steps>
  ...
  <Step title="Tune per-agent behavior">
    In Operator Mode, set an agent to use the account default, ask for this agent, or bypass for this agent depending on the workflow's risk and maturity.
  </Step>
</Steps>
