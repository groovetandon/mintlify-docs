...
<Steps>
  <Step title="Visit Decisional">
    Go to [app.decisional.com/sign-up](https://app.decisional.com/sign-up)
  </Step>
...
- **Pop-ups allowed** for app.decisional.com (for OAuth integrations)
...
<Card title="Upgrade Your Plan" icon="arrow-up" href="https://app.decisional.com/settings/billing">
...
<AccordionGroup>
  ...
  <Accordion title="Can't sign in with Google" icon="google">
    **Common causes:**
    1. Pop-ups are blocked (allow pop-ups for app.decisional.com)
