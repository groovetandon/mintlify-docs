...
Once you submit, Dex starts a conversation to understand what you need. Your agent may ask a few clarifying questions, then it selects the right integrations and tools for the job.
...
<Card title="Workflows" icon="diagram-project" href="/workflows/overview">
  Learn how trigger nodes, task nodes, action nodes, AI nodes, RAG nodes, and gate nodes fit together.
</Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Dex and Agent Modes" icon="message" href="/agents/modes">
    Understand Chat Mode, Operator Mode, and Public Mode
  </Card>
</CardGroup>
