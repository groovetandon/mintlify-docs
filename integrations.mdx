...
<CardGroup cols={2}>
  <Card title="Triggers" icon="bolt">
    Start agents from schedules, integration events, webhooks, form submissions, chat commands, or manual runs.
  </Card>
...
| **GitHub PR Review Agent** | Product & engineering | Slack command or new PR | GitHub, Slackbot | PR review comments and thread summary |
...
| **Chat command** | A person should start work conversationally | GitHub PR Review Agent |
