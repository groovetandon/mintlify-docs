...
<Card title="Why Integrations Matter" icon="lightbulb">
  Integrations let agents interact with the systems where work actually happens - sending emails, updating records, fetching live data, and posting updates.
</Card>
...
2. Send an email via Gmail to the customer:
   - To: Customer email from the request record
   - Subject: "Your Quote from Acme Corp"
   - Body: "Thank you for your interest..."
   - Attach the quote PDF
3. Mark the request as "Sent"
```
...
<Card title="Request Integration" icon="plus" href="mailto:founders@decisional.com?subject=Integration Request">
  Email us at founders@decisional.com with:
  - Service name
...
<CardGroup cols={2}>
  ...
  <Card title="Approvals and Policy" icon="user-check" href="/agents/approvals">
    Control which integration actions need review
  </Card>
</CardGroup>
