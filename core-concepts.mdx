...
- **Public Mode** for focused run and review pages that can be shared without exposing the builder interface

<Card title="Dex and Agent Modes" icon="message" href="/agents/modes">
  Learn how Dex, agents, Chat Mode, Operator Mode, and Public Mode fit together.
</Card>
...
| **Public Mode** | Share a focused run page with people who should run or review work without changing the agent |
